...
class run {
    ...
    fun init() {
        ...
        req.open("GET", "http://"+ Backend.url + ":8080/api/workload/" + workloadID, true)
        req.send()
        ...
        req2.open("GET", "http://"+ Backend.url + ":8080/api/oasFiles/" + oas + "/endpoints", true)
        req2.send()
    ...
    private fun sendWorkerInfoToBackend() {
        ...
        req.open("POST", "http://"+ Backend.url + ":8080/api/run/worker", true)
    ...
    private fun checkStatusOfBackendWorker() {
        ...
        req.open("GET", "http://"+ Backend.url + ":8080/api/run/ensureWorkerWaiting/" + workersetID, true)
        req.send()
    }
    ...
    private fun initWorkers() {
        ...
        req.open("GET", "http://"+ Backend.url + ":8080/api/run/initWorker/" + workersetID + "?endpoint=" + tbxEndpoint.value, true)
        req.send()
    }
    ...
    private fun distributeWorkload() {
        ...
        req.open("GET", "http://"+ Backend.url + ":8080/api/run/distribute/" + workersetID + "?workload=" + workloadID, true)
        req.send()
    }
    ...
    private fun startBenchmark() {
        ...
        req.open("GET", "http://"+ Backend.url + ":8080/api/run/start/" + workersetID, true)
        req.send()
    }
    ...
    fun receiveNotifications() {
        ...
        req.open("GET", "http://"+ Backend.url + ":8080/api/run/notification/" + workersetID, true)
        req.send()
    }
    ...
    private fun collectResults() {
        ...
        req.open("GET", "http://"+ Backend.url + ":8080/api/run/collect/" + workersetID, true)
        req.send()
    }
    ...
    fun refreshWorkerStatus() {
        ...
        for (w in worker.asList()) {
            ...
            var url = "http://"+ Backend.url + ":8080/api/run/workerstatus?url=" + w.url
            val req = XMLHttpRequest()
            req.onloadend = fun(event: Event) {
